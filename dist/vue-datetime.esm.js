...
function monthDayIsDisabled (minDate, maxDate, year, month, day) {
  var date = DateTime.fromObject({ year: year, month: month, day: day, zone: 'UTC' });
...
export { Datetime, DatetimePopup, version };export default plugin;
